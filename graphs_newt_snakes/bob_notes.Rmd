---
title: "Bob Simulation Sugestion"
...
foldername=bob_suggestion/both_lower_w_no_exp
...
# Requirements: need to have the same name and need to add additional columns
thepath=/Users/victoria/Desktop/
foldername=bob_suggestion/lower_w
thefolder=${thepath}${foldername}/*
...
# Requirements: need to have the same name and need to add additional columns
thepath=/Users/victoria/Desktop/
foldername=bob_suggestion/no_exp
thefolder=${thepath}${foldername}/*
...
both_lower_w_no_exp_lit<- read.csv("~/Desktop/bob_suggestion/both_lower_w_no_exp/all_lit.txt" , header = TRUE)

both_lower_w_no_exp_lit$group_rep <- paste0(both_lower_w_no_exp_lit$snake_mu_rate, "_", both_lower_w_no_exp_lit$snake_mu_effect_sd,"_",both_lower_w_no_exp_lit$newt_mu_rate, "_", both_lower_w_no_exp_lit$newt_mu_effect_sd, "_", both_lower_w_no_exp_lit$rep)

both_lower_w_no_exp_lit$group <- paste0(both_lower_w_no_exp_lit$snake_mu_rate, "_", both_lower_w_no_exp_lit$snake_mu_effect_sd,"_",both_lower_w_no_exp_lit$newt_mu_rate, "_", both_lower_w_no_exp_lit$newt_mu_effect_sd)

both_lower_w_no_exp_lit$sim=LETTERS[factor(both_lower_w_no_exp_lit$group)]
both_lower_w_no_exp_lit$dif <- both_lower_w_no_exp_lit$Snake_mean_Pheno-both_lower_w_no_exp_lit$Newt_mean_Pheno


both_lower_w_no_exp_cor<- read.csv("~/Desktop/bob_suggestion/both_lower_w_no_exp/all_cor.txt" , header = TRUE)
both_lower_w_no_exp_cor$group_rep <- paste0(both_lower_w_no_exp_cor$snake_mu_rate, "_", both_lower_w_no_exp_cor$snake_mu_effect_sd,"_",both_lower_w_no_exp_cor$newt_mu_rate, "_", both_lower_w_no_exp_cor$newt_mu_effect_sd, "_", both_lower_w_no_exp_cor$rep)
both_lower_w_no_exp_cor$group <- paste0(both_lower_w_no_exp_cor$snake_mu_rate, "_", both_lower_w_no_exp_cor$snake_mu_effect_sd,"_",both_lower_w_no_exp_cor$newt_mu_rate, "_", both_lower_w_no_exp_cor$newt_mu_effect_sd)
both_lower_w_no_exp_cor$sim=LETTERS[factor(both_lower_w_no_exp_cor$group)]


# lower w
lower_w_lit<- read.csv("~/Desktop/bob_suggestion/lower_w/all_lit.txt" , header = TRUE)

lower_w_lit$group_rep <- paste0(lower_w_lit$snake_mu_rate, "_", lower_w_lit$snake_mu_effect_sd,"_",lower_w_lit$newt_mu_rate, "_", lower_w_lit$newt_mu_effect_sd, "_", lower_w_lit$rep)

lower_w_lit$group <- paste0(lower_w_lit$snake_mu_rate, "_", lower_w_lit$snake_mu_effect_sd,"_",lower_w_lit$newt_mu_rate, "_", lower_w_lit$newt_mu_effect_sd)

lower_w_lit$sim=LETTERS[factor(lower_w_lit$group)]
lower_w_lit$dif <- lower_w_lit$Snake_mean_Pheno-lower_w_lit$Newt_mean_Pheno


lower_w_cor<- read.csv("~/Desktop/bob_suggestion/lower_w/all_cor.txt" , header = TRUE)
lower_w_cor$group_rep <- paste0(lower_w_cor$snake_mu_rate, "_", lower_w_cor$snake_mu_effect_sd,"_",lower_w_cor$newt_mu_rate, "_", lower_w_cor$newt_mu_effect_sd, "_", lower_w_cor$rep)
lower_w_cor$group <- paste0(lower_w_cor$snake_mu_rate, "_", lower_w_cor$snake_mu_effect_sd,"_",lower_w_cor$newt_mu_rate, "_", lower_w_cor$newt_mu_effect_sd)
lower_w_cor$sim=LETTERS[factor(lower_w_cor$group)]

# no exp

no_exp_lit<- read.csv("~/Desktop/bob_suggestion/no_exp/all_lit.txt" , header = TRUE)

no_exp_lit$group_rep <- paste0(no_exp_lit$snake_mu_rate, "_", no_exp_lit$snake_mu_effect_sd,"_",no_exp_lit$newt_mu_rate, "_", no_exp_lit$newt_mu_effect_sd, "_", no_exp_lit$rep)

no_exp_lit$group <- paste0(no_exp_lit$snake_mu_rate, "_", no_exp_lit$snake_mu_effect_sd,"_",no_exp_lit$newt_mu_rate, "_", no_exp_lit$newt_mu_effect_sd)

no_exp_lit$sim=LETTERS[factor(no_exp_lit$group)]
no_exp_lit$dif <- no_exp_lit$Snake_mean_Pheno-no_exp_lit$Newt_mean_Pheno


no_exp_cor<- read.csv("~/Desktop/bob_suggestion/no_exp/all_cor.txt" , header = TRUE)
no_exp_cor$group_rep <- paste0(no_exp_cor$snake_mu_rate, "_", no_exp_cor$snake_mu_effect_sd,"_",no_exp_cor$newt_mu_rate, "_", no_exp_cor$newt_mu_effect_sd, "_", no_exp_cor$rep)
no_exp_cor$group <- paste0(no_exp_cor$snake_mu_rate, "_", no_exp_cor$snake_mu_effect_sd,"_",no_exp_cor$newt_mu_rate, "_", no_exp_cor$newt_mu_effect_sd)
no_exp_cor$sim=LETTERS[factor(no_exp_cor$group)]
...
#file=both_lower_w_no_exp_lit
#cfile=both_lower_w_no_exp_cor 
...
#two_hist_death_all_rep(both_lower_w_no_exp_lit, title="Snake-Newt Winning Hist", subt="Gen 16sims", y_label="Count", x_label="Snake-Newt Phenotype (purple) & Snake-Newt Popsize/100 (green)",  min_gen=20000, max_gen=25000)
...
```{r, graphing by gen}
trends_by_gen(both_lower_w_no_exp_lit, title="Space Tall: Newt VS Snake Population Size GA1", subt="Gen 16sims", y_label="Mean Phenotype", x_label="Generations", 100, 50000, rep=1)


#aggregate(both_lower_w_no_exp_lit[which(both_lower_w_no_exp_lit$generation>=100 & both_lower_w_no_exp_lit$generation<=50000),]$dif, list(both_lower_w_no_exp_lit[which(both_lower_w_no_exp_lit$generation>=100 & both_lower_w_no_exp_lit$generation<=50000),]$group_rep), FUN=mean) 
...
aggregate(both_lower_w_no_exp_lit[which(both_lower_w_no_exp_lit$generation>=100 & both_lower_w_no_exp_lit$generation<=50000),]$dif, list(both_lower_w_no_exp_lit[which(both_lower_w_no_exp_lit$generation>=100 & both_lower_w_no_exp_lit$generation<=50000),]$group), FUN=mean) 
```

### Phenotype differences (lower_w)
```{r, graphing by gen lw}
trends_by_gen(lower_w_lit, title="Space Tall: Newt VS Snake Population Size GA1", subt="Gen 16sims", y_label="Mean Phenotype", x_label="Generations", 100, 50000, rep=1)
...
aggregate(lower_w_lit[which(lower_w_lit$generation>=100 & lower_w_lit$generation<=50000),]$dif, list(lower_w_lit[which(lower_w_lit$generation>=100 & lower_w_lit$generation<=50000),]$group), FUN=mean) 
```

### Phenotype differences (no_exp)
```{r, graphing by gen ne}
trends_by_gen(no_exp_lit, title="Space Tall: Newt VS Snake Population Size GA1", subt="Gen 16sims", y_label="Mean Phenotype", x_label="Generations", 100, 50000, rep=1)
...
aggregate(no_exp_lit[which(no_exp_lit$generation>=100 & no_exp_lit$generation<=50000),]$dif, list(no_exp_lit[which(no_exp_lit$generation>=100 & no_exp_lit$generation<=50000),]$group), FUN=mean) 
```
...
whale_gen(both_lower_w_no_exp_lit, title="Space: Newt VS Snake Population Size Color=S-N Phenotype", subt="Gen 16sims", y_label="Snake Popsize", x_label="Newt Popsize", min_gen=min_gen, max_gen=max_gen, rep=rep )
```

### Phenotype & Populationsize differences (both_lower_w_no_exp)
```{r, popsize and pheno}

suppressMessages(print(two_hist(both_lower_w_no_exp_lit, title="Snake-Newt Winning Hist", subt="Gen 16sims", y_label="Count", x_label="Snake-Newt Popsize/1000 (green) & Snake-Newt Phenotype (purple)",  min_gen=min_gen, max_gen=max_gen, rep=rep )))
...
whale_gen(lower_w_lit, title="Space: Newt VS Snake Population Size Color=S-N Phenotype", subt="Gen 16sims", y_label="Snake Popsize", x_label="Newt Popsize", min_gen=min_gen, max_gen=max_gen, rep=rep )
```

### Phenotype & Populationsize differences (lower_w)
```{r, popsize and pheno lw}

suppressMessages(print(two_hist(lower_w_lit, title="Snake-Newt Winning Hist", subt="Gen 16sims", y_label="Count", x_label="Snake-Newt Popsize/1000 (green) & Snake-Newt Phenotype (purple)",  min_gen=min_gen, max_gen=max_gen, rep=rep )))
...
whale_gen(no_exp_lit, title="Space: Newt VS Snake Population Size Color=S-N Phenotype", subt="Gen 16sims", y_label="Snake Popsize", x_label="Newt Popsize", min_gen=min_gen, max_gen=max_gen, rep=rep )
```

### Phenotype & Populationsize differences (no_exp)
```{r, popsize and pheno ne}

suppressMessages(print(two_hist(no_exp_lit, title="Snake-Newt Winning Hist", subt="Gen 16sims", y_label="Count", x_label="Snake-Newt Popsize/1000 (green) & Snake-Newt Phenotype (purple)",  min_gen=min_gen, max_gen=max_gen, rep=rep )))
...
boxplot_cors_by_gen(both_lower_w_no_exp_cor, "Simulation Correlation Comparied to Real Correlation Trials", "GA1", "newt/snake GAs&rep", "Cor", ginmin, ginmax)
...
boxplot_cors_by_gen(lower_w_cor, "Simulation Correlation Comparied to Real Correlation Trials", "GA1", "newt/snake GAs&rep", "Cor", ginmin, ginmax)
...
boxplot_cors_by_gen(no_exp_cor, "Simulation Correlation Comparied to Real Correlation Trials", "GA1", "newt/snake GAs&rep", "Cor", ginmin, ginmax)
...
## Correlation Histograms Both{.tabset}
...
ginmin = 0
ginmax = 5000
suppressMessages(print(hist_cors_by_gen_col_rep(both_lower_w_no_exp_cor, "Simulation Correlation Comparied to Real Correlation", "GA1", "newt/snake GAs&rep", "Cor", ginmin, ginmax)))
```
...
## Correlation Histograms Lower w {.tabset}
...
ginmin = 0
ginmax = 5000
suppressMessages(print(hist_cors_by_gen_col_rep(lower_w_cor, "Simulation Correlation Comparied to Real Correlation", "GA1", "newt/snake GAs&rep", "Cor", ginmin, ginmax)))
```
...
## Correlation Histograms no exp {.tabset}
...
ginmin = 0
ginmax = 5000
suppressMessages(print(hist_cors_by_gen_col_rep(no_exp_cor, "Simulation Correlation Comparied to Real Correlation", "GA1", "newt/snake GAs&rep", "Cor", ginmin, ginmax)))
```
...
## Correlation across time (both_lower_w_no_exp)  {.tabset}
...
```{r, GA1 cor and pheno}
GA1_pattern <- unique(paste0(both_lower_w_no_exp_lit$snake_mu_rate, "_", both_lower_w_no_exp_lit$snake_mu_effect_sd,"_",both_lower_w_no_exp_lit$newt_mu_rate, "_", both_lower_w_no_exp_lit$newt_mu_effect_sd, "_", both_lower_w_no_exp_lit$rep))

myrandomlist=sample.int(length(GA1_pattern), 3)

# for(i in myrandomlist){
#   myine<-cor_trends_by_gen(both_lower_w_no_exp_lit, both_lower_w_no_exp_cor, "test", "GA1", "newt/snake GAs&rep","other", "Cor", min_gen=100, max_gen=50000, pattern=GA1_pattern[i])
#   plot(myine)
# }

cor_trends_by_gen(both_lower_w_no_exp_lit, both_lower_w_no_exp_cor, "test", "GA1", "newt/snake GAs&rep","other", "Cor", min_gen=100, max_gen=50000, pattern=GA1_pattern[myrandomlist[1]])
...
cor_trends_by_gen(both_lower_w_no_exp_lit, both_lower_w_no_exp_cor, "test", "GA1", "newt/snake GAs&rep","other", "Cor", min_gen=100, max_gen=50000, pattern=GA1_pattern[myrandomlist[2]])
```

### Random 3  (both_lower_w_no_exp)
```{r, random cor-pheno plot 3}

cor_trends_by_gen(both_lower_w_no_exp_lit, both_lower_w_no_exp_cor, "test", "GA1", "newt/snake GAs&rep","other", "Cor", min_gen=100, max_gen=50000, pattern=GA1_pattern[myrandomlist[3]])
```

## {-}

## Correlation across time (lower_w)  {.tabset}



### Random 1 (lower_w)  
```{r, GA1 cor and pheno  lw}
GA1_pattern <- unique(paste0(lower_w_lit$snake_mu_rate, "_", lower_w_lit$snake_mu_effect_sd,"_",lower_w_lit$newt_mu_rate, "_", lower_w_lit$newt_mu_effect_sd, "_", lower_w_lit$rep))

myrandomlist=sample.int(length(GA1_pattern), 3)

# for(i in myrandomlist){
#   myine<-cor_trends_by_gen(lower_w_lit, lower_w_cor, "test", "GA1", "newt/snake GAs&rep","other", "Cor", min_gen=100, max_gen=50000, pattern=GA1_pattern[i])
#   plot(myine)
# }

cor_trends_by_gen(lower_w_lit, lower_w_cor, "test", "GA1", "newt/snake GAs&rep","other", "Cor", min_gen=100, max_gen=50000, pattern=GA1_pattern[myrandomlist[1]])
...
cor_trends_by_gen(lower_w_lit, lower_w_cor, "test", "GA1", "newt/snake GAs&rep","other", "Cor", min_gen=100, max_gen=50000, pattern=GA1_pattern[myrandomlist[2]])
```

### Random 3  (lower_w)
```{r, random cor-pheno plot 3  lw}

cor_trends_by_gen(lower_w_lit, lower_w_cor, "test", "GA1", "newt/snake GAs&rep","other", "Cor", min_gen=100, max_gen=50000, pattern=GA1_pattern[myrandomlist[3]])
```
...
## Correlation across time (no_exp)  {.tabset}


### Random 1 (no_exp)  
```{r, GA1 cor and pheno ne}
GA1_pattern <- unique(paste0(no_exp_lit$snake_mu_rate, "_", no_exp_lit$snake_mu_effect_sd,"_",no_exp_lit$newt_mu_rate, "_", no_exp_lit$newt_mu_effect_sd, "_", no_exp_lit$rep))

myrandomlist=sample.int(length(GA1_pattern), 3)

# for(i in myrandomlist){
#   myine<-cor_trends_by_gen(no_exp_lit, no_exp_cor, "test", "GA1", "newt/snake GAs&rep","other", "Cor", min_gen=100, max_gen=50000, pattern=GA1_pattern[i])
#   plot(myine)
# }

cor_trends_by_gen(no_exp_lit, no_exp_cor, "test", "GA1", "newt/snake GAs&rep","other", "Cor", min_gen=100, max_gen=50000, pattern=GA1_pattern[myrandomlist[1]])
...
cor_trends_by_gen(no_exp_lit, no_exp_cor, "test", "GA1", "newt/snake GAs&rep","other", "Cor", min_gen=100, max_gen=50000, pattern=GA1_pattern[myrandomlist[2]])
```

### Random 3  (no_exp)
```{r, random cor-pheno plot 3 ne}

cor_trends_by_gen(no_exp_lit, no_exp_cor, "test", "GA1", "newt/snake GAs&rep","other", "Cor", min_gen=100, max_gen=50000, pattern=GA1_pattern[myrandomlist[3]])
```
...
## What happens over time (looking at the beginning, middle, and late part of my simulations) (both_lower_w_no_exp) {.tabset}
...
# for(i in 1:length(unique(both_lower_w_no_exp_lit$rep))){
#   myine<-whale_gen(both_lower_w_no_exp_lit, title="Space: Newt VS Snake Population Size Color=S-N Phenotype", subt="Gen 16sims", y_label="Snake Popsize", x_label="Newt Popsize", min_gen=min_gen, max_gen=max_gen, rep=unique(both_lower_w_no_exp_lit$rep)[i])
#   plot(myine)
# 
# }
whale_gen(both_lower_w_no_exp_lit, title="Space: Newt VS Snake Population Size Color=S-N Phenotype", subt="Gen 16sims", y_label="Snake Popsize", x_label="Newt Popsize", min_gen=min_gen, max_gen=max_gen, rep=unique(both_lower_w_no_exp_lit$rep)[1])
```
...
# for(i in 1:length(unique(both_lower_w_no_exp_lit$rep))){
#   myine<-two_hist(both_lower_w_no_exp_lit, title="Snake-Newt Winning Hist", subt="Gen 16sims", y_label="Count", x_label="Snake-Newt Phenotype (purple) & Snake-Newt Popsize/100 (green)",  min_gen=min_gen, max_gen=max_gen, rep=unique(both_lower_w_no_exp_lit$rep)[i] )
#   suppressMessages(plot(myine))
# }

two_hist(both_lower_w_no_exp_lit, title="Snake-Newt Winning Hist", subt="Gen 16sims", y_label="Count", x_label="Snake-Newt Phenotype (purple) & Snake-Newt Popsize/100 (green)",  min_gen=min_gen, max_gen=max_gen, rep=unique(both_lower_w_no_exp_lit$rep)[1] )
...
## What happens over time (looking at the beginning, middle, and late part of my simulations) (lower_w) {.tabset}
...
# for(i in 1:length(unique(lower_w_lit$rep))){
#   myine<-whale_gen(lower_w_lit, title="Space: Newt VS Snake Population Size Color=S-N Phenotype", subt="Gen 16sims", y_label="Snake Popsize", x_label="Newt Popsize", min_gen=min_gen, max_gen=max_gen, rep=unique(lower_w_lit$rep)[i])
#   plot(myine)
# 
# }
whale_gen(lower_w_lit, title="Space: Newt VS Snake Population Size Color=S-N Phenotype", subt="Gen 16sims", y_label="Snake Popsize", x_label="Newt Popsize", min_gen=min_gen, max_gen=max_gen, rep=unique(lower_w_lit$rep)[1])
```
...
# for(i in 1:length(unique(lower_w_lit$rep))){
#   myine<-two_hist(lower_w_lit, title="Snake-Newt Winning Hist", subt="Gen 16sims", y_label="Count", x_label="Snake-Newt Phenotype (purple) & Snake-Newt Popsize/100 (green)",  min_gen=min_gen, max_gen=max_gen, rep=unique(lower_w_lit$rep)[i] )
#   suppressMessages(plot(myine))
# }

two_hist(lower_w_lit, title="Snake-Newt Winning Hist", subt="Gen 16sims", y_label="Count", x_label="Snake-Newt Phenotype (purple) & Snake-Newt Popsize/100 (green)",  min_gen=min_gen, max_gen=max_gen, rep=unique(lower_w_lit$rep)[1] )
...
## What happens over time (looking at the beginning, middle, and late part of my simulations) (no_exp) {.tabset}
...
# for(i in 1:length(unique(no_exp_lit$rep))){
#   myine<-whale_gen(no_exp_lit, title="Space: Newt VS Snake Population Size Color=S-N Phenotype", subt="Gen 16sims", y_label="Snake Popsize", x_label="Newt Popsize", min_gen=min_gen, max_gen=max_gen, rep=unique(no_exp_lit$rep)[i])
#   plot(myine)
# 
# }
whale_gen(no_exp_lit, title="Space: Newt VS Snake Population Size Color=S-N Phenotype", subt="Gen 16sims", y_label="Snake Popsize", x_label="Newt Popsize", min_gen=min_gen, max_gen=max_gen, rep=unique(no_exp_lit$rep)[1])
```
...
# for(i in 1:length(unique(no_exp_lit$rep))){
#   myine<-two_hist(no_exp_lit, title="Snake-Newt Winning Hist", subt="Gen 16sims", y_label="Count", x_label="Snake-Newt Phenotype (purple) & Snake-Newt Popsize/100 (green)",  min_gen=min_gen, max_gen=max_gen, rep=unique(no_exp_lit$rep)[i] )
#   suppressMessages(plot(myine))
# }

two_hist(no_exp_lit, title="Snake-Newt Winning Hist", subt="Gen 16sims", y_label="Count", x_label="Snake-Newt Phenotype (purple) & Snake-Newt Popsize/100 (green)",  min_gen=min_gen, max_gen=max_gen, rep=unique(no_exp_lit$rep)[1] )
...
## Summary (both_lower_w_no_exp) {.tabset}
...
min_gen=100
max_gen=5000
GA_summary(both_lower_w_no_exp_lit, min_gen=min_gen, max_gen=max_gen, x_line="Newt_pop_size", y_line="Snake_pop_size", title="Space: Newt VS Snake Population Size", subt="Gen 16sims", y_label="Snake Popsize", x_label="Newt Popsize")
```
...
GA_summary(both_lower_w_no_exp_lit, min_gen=min_gen, max_gen=max_gen, x_line="dif", y_line="Snake_pop_size", title="Space: Dif VS Snake Population Size", subt="Gen 16sims", y_label="Snake Popsize", x_label="Dif")
```
...
GA_summary_by_species(both_lower_w_no_exp_lit, min_gen=min_gen, max_gen=max_gen, x_line="dif", y_line="snake", title="Space: Dif VS Snake GA", subt="Gen 16sims", y_label="Snake GA", x_label="Dif")
...
GA_summary_by_species(both_lower_w_no_exp_lit, min_gen=min_gen, max_gen=max_gen, x_line="dif", y_line="newt", title="Space: Dif VS Newt GA", subt="Gen 16sims", y_label="Newt GA", x_label="Dif")
...
min_gen=100
max_gen=5000
GA_summary(lower_w_lit, min_gen=min_gen, max_gen=max_gen, x_line="Newt_pop_size", y_line="Snake_pop_size", title="Space: Newt VS Snake Population Size", subt="Gen 16sims", y_label="Snake Popsize", x_label="Newt Popsize")
```
...
GA_summary(lower_w_lit, min_gen=min_gen, max_gen=max_gen, x_line="dif", y_line="Snake_pop_size", title="Space: Dif VS Snake Population Size", subt="Gen 16sims", y_label="Snake Popsize", x_label="Dif")
```
...
GA_summary_by_species(lower_w_lit, min_gen=min_gen, max_gen=max_gen, x_line="dif", y_line="snake", title="Space: Dif VS Snake GA", subt="Gen 16sims", y_label="Snake GA", x_label="Dif")
...
GA_summary_by_species(lower_w_lit, min_gen=min_gen, max_gen=max_gen, x_line="dif", y_line="newt", title="Space: Dif VS Newt GA", subt="Gen 16sims", y_label="Newt GA", x_label="Dif")
...
min_gen=100
max_gen=5000
GA_summary(no_exp_lit, min_gen=min_gen, max_gen=max_gen, x_line="Newt_pop_size", y_line="Snake_pop_size", title="Space: Newt VS Snake Population Size", subt="Gen 16sims", y_label="Snake Popsize", x_label="Newt Popsize")
```
...
GA_summary(no_exp_lit, min_gen=min_gen, max_gen=max_gen, x_line="dif", y_line="Snake_pop_size", title="Space: Dif VS Snake Population Size", subt="Gen 16sims", y_label="Snake Popsize", x_label="Dif")
```
...
GA_summary_by_species(no_exp_lit, min_gen=min_gen, max_gen=max_gen, x_line="dif", y_line="snake", title="Space: Dif VS Snake GA", subt="Gen 16sims", y_label="Snake GA", x_label="Dif")
...
GA_summary_by_species(no_exp_lit, min_gen=min_gen, max_gen=max_gen, x_line="dif", y_line="newt", title="Space: Dif VS Newt GA", subt="Gen 16sims", y_label="Newt GA", x_label="Dif")
...
max_gen=5000
#heatmap
build_heatmap(both_lower_w_no_exp_lit, min_gen=min_gen, max_gen=max_gen, fill_line="Snake_pop_size", fill_line_text="Snake Population Size", title="Newt GA by Snake GA", subt="16 Sim Heatmap", y_label="Snake GA", x_label="Newt GA", red_blue=F)
```
...
min_gen=100
max_gen=5000
build_heatmap(both_lower_w_no_exp_lit, min_gen=min_gen, max_gen=max_gen, fill_line="dif", fill_line_text="Snake-Newt", title="Newt GA by Snake GA", subt="16 Sim Heatmap", y_label="Snake GA", x_label="Newt GA",red_blue=T)
```
...
max_gen=5000
#heatmap
build_heatmap(lower_w_lit, min_gen=min_gen, max_gen=max_gen, fill_line="Snake_pop_size", fill_line_text="Snake Population Size", title="Newt GA by Snake GA", subt="16 Sim Heatmap", y_label="Snake GA", x_label="Newt GA", red_blue=F)
```
...
min_gen=100
max_gen=5000
build_heatmap(lower_w_lit, min_gen=min_gen, max_gen=max_gen, fill_line="dif", fill_line_text="Snake-Newt", title="Newt GA by Snake GA", subt="16 Sim Heatmap", y_label="Snake GA", x_label="Newt GA",red_blue=T)
```
...
max_gen=5000
#heatmap
build_heatmap(no_exp_lit, min_gen=min_gen, max_gen=max_gen, fill_line="Snake_pop_size", fill_line_text="Snake Population Size", title="Newt GA by Snake GA", subt="16 Sim Heatmap", y_label="Snake GA", x_label="Newt GA", red_blue=F)
```
...
min_gen=100
max_gen=5000
build_heatmap(no_exp_lit, min_gen=min_gen, max_gen=max_gen, fill_line="dif", fill_line_text="Snake-Newt", title="Newt GA by Snake GA", subt="16 Sim Heatmap", y_label="Snake GA", x_label="Newt GA",red_blue=T)
```
...
In the both low w and no exp experiment about half the values are missing. There is some agreement between trials on snake population size there might be a relationship between snake GA and newt GA in that when there is more mutational arrange in the snake GA the snake population size and phenotype increases. This is not true for the newts.
In the low w experiment there is only a relationship between snake GA and newt GA when viewing the extreme GA combinations. When the GA creates the highest and the low mutational variance the species with the higher MV will have a higher phenotype and population size. All other GA combinations had average snake population size with some variation in the mean phenotype difference.
In the no exp experiment there is agreement amongst the GA trials. There is a difference between the snake GA and not the newt GA. As the snakes GA with mutational variance gets smaller so does the population size. As the snakes GA with mutational variance gets smaller the difference between snake and newt mean phenotype gets longer (newts have a higher mean phenotype).

<!-- ```{r, red in grid files} -->
<!-- require(readr) -->
<!-- both_lower_w_no_exp_grid<- read.csv("~/Desktop/bob_suggestion/both_lower_w_no_exp/all_grid.txt" , header = TRUE) %>%  filter(between(generation, 9000, 10000)) -->
<!-- both_lower_w_no_exp_grid$group_rep <- paste0(both_lower_w_no_exp_grid$snake_mu_rate, "_", both_lower_w_no_exp_grid$snake_mu_effect_sd,"_",both_lower_w_no_exp_grid$newt_mu_rate, "_", both_lower_w_no_exp_grid$newt_mu_effect_sd, "_", both_lower_w_no_exp_grid$rep) -->
<!-- both_lower_w_no_exp_grid$group <- paste0(both_lower_w_no_exp_grid$snake_mu_rate, "_", both_lower_w_no_exp_grid$snake_mu_effect_sd,"_",both_lower_w_no_exp_grid$newt_mu_rate, "_", both_lower_w_no_exp_grid$newt_mu_effect_sd) -->
<!-- both_lower_w_no_exp_grid$sim=LETTERS[factor(both_lower_w_no_exp_grid$group)] -->
<!-- both_lower_w_no_exp_grid$grid_num = 5 -->
...
<!-- require(readr) -->
<!-- lower_w_grid<- read.csv("~/Desktop/bob_suggestion/lower_w/all_grid.txt" , header = TRUE) %>%  filter(between(generation, 9000, 10000)) -->
<!-- lower_w_grid$group_rep <- paste0(lower_w_grid$snake_mu_rate, "_", lower_w_grid$snake_mu_effect_sd,"_",lower_w_grid$newt_mu_rate, "_", lower_w_grid$newt_mu_effect_sd, "_", lower_w_grid$rep) -->
<!-- lower_w_grid$group <- paste0(lower_w_grid$snake_mu_rate, "_", lower_w_grid$snake_mu_effect_sd,"_",lower_w_grid$newt_mu_rate, "_", lower_w_grid$newt_mu_effect_sd) -->
<!-- lower_w_grid$sim=LETTERS[factor(lower_w_grid$group)] -->
<!-- lower_w_grid$grid_num = 5 -->

<!-- ``` -->

<!-- ```{r, red in grid files ne} -->
<!-- require(readr) -->
<!-- no_exp_grid<- read.csv("~/Desktop/bob_suggestion/no_exp/all_grid.txt" , header = TRUE) %>%  filter(between(generation, 9000, 10000)) -->
<!-- no_exp_grid$group_rep <- paste0(no_exp_grid$snake_mu_rate, "_", no_exp_grid$snake_mu_effect_sd,"_",no_exp_grid$newt_mu_rate, "_", no_exp_grid$newt_mu_effect_sd, "_", no_exp_grid$rep) -->
<!-- no_exp_grid$group <- paste0(no_exp_grid$snake_mu_rate, "_", no_exp_grid$snake_mu_effect_sd,"_",no_exp_grid$newt_mu_rate, "_", no_exp_grid$newt_mu_effect_sd) -->
<!-- no_exp_grid$sim=LETTERS[factor(no_exp_grid$group)] -->
<!-- no_exp_grid$grid_num = 5 -->

<!-- ``` -->

<!-- ## What is up with the correlations -->

<!-- ## Early Simulation Correlation (both_lower_w_no_exp)  {.tabset} -->


<!-- ### Mean  -->
<!-- ```{r, cor grid high cor mean} -->

<!-- file=both_lower_w_no_exp_grid -->
...
<!-- ## Early Simulation Correlation (lower_w)  {.tabset} -->
...
<!-- ## Early Simulation Correlation (no_exp)  {.tabset} -->
...
<!-- require(readr) -->
<!-- both_lower_w_no_exp_grid<- read.csv("~/Desktop/both_lower_w_no_exp/all_grid.txt" , header = TRUE) %>%  filter(between(generation, 40000, 50000)) -->
<!-- both_lower_w_no_exp_grid$group_rep <- paste0(both_lower_w_no_exp_grid$snake_mu_rate, "_", both_lower_w_no_exp_grid$snake_mu_effect_sd,"_",both_lower_w_no_exp_grid$newt_mu_rate, "_", both_lower_w_no_exp_grid$newt_mu_effect_sd, "_", both_lower_w_no_exp_grid$rep) -->
<!-- both_lower_w_no_exp_grid$group <- paste0(both_lower_w_no_exp_grid$snake_mu_rate, "_", both_lower_w_no_exp_grid$snake_mu_effect_sd,"_",both_lower_w_no_exp_grid$newt_mu_rate, "_", both_lower_w_no_exp_grid$newt_mu_effect_sd) -->
<!-- both_lower_w_no_exp_grid$sim=LETTERS[factor(both_lower_w_no_exp_grid$group)] -->
<!-- both_lower_w_no_exp_grid$grid_num = 5 -->
...
<!-- require(readr) -->
<!-- lower_w_grid<- read.csv("~/Desktop/lower_w/all_grid.txt" , header = TRUE) %>%  filter(between(generation, 40000, 50000)) -->
<!-- lower_w_grid$group_rep <- paste0(lower_w_grid$snake_mu_rate, "_", lower_w_grid$snake_mu_effect_sd,"_",lower_w_grid$newt_mu_rate, "_", lower_w_grid$newt_mu_effect_sd, "_", lower_w_grid$rep) -->
<!-- lower_w_grid$group <- paste0(lower_w_grid$snake_mu_rate, "_", lower_w_grid$snake_mu_effect_sd,"_",lower_w_grid$newt_mu_rate, "_", lower_w_grid$newt_mu_effect_sd) -->
<!-- lower_w_grid$sim=LETTERS[factor(lower_w_grid$group)] -->
<!-- lower_w_grid$grid_num = 5 -->
...
<!-- require(readr) -->
<!-- no_exp_grid<- read.csv("~/Desktop/no_exp/all_grid.txt" , header = TRUE) %>%  filter(between(generation, 40000, 50000)) -->
<!-- no_exp_grid$group_rep <- paste0(no_exp_grid$snake_mu_rate, "_", no_exp_grid$snake_mu_effect_sd,"_",no_exp_grid$newt_mu_rate, "_", no_exp_grid$newt_mu_effect_sd, "_", no_exp_grid$rep) -->
<!-- no_exp_grid$group <- paste0(no_exp_grid$snake_mu_rate, "_", no_exp_grid$snake_mu_effect_sd,"_",no_exp_grid$newt_mu_rate, "_", no_exp_grid$newt_mu_effect_sd) -->
<!-- no_exp_grid$sim=LETTERS[factor(no_exp_grid$group)] -->
<!-- no_exp_grid$grid_num = 5 -->
...
<!-- ## Late Simulation Correlation (both_lower_w_no_exp) {.tabset} -->
...
<!-- ## Late Simulation Correlation (lower_w) {.tabset} -->
...
<!-- ## Late Simulation Correlation (no_exp) {.tabset} -->
