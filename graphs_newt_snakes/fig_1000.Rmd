...
for (current_file in files){
  ...
  if (max(file$Newt_max_Pheno, na.rm = TRUE) > newt_max_pheno){
    newt_max_pheno = max(file$Newt_max_Pheno, na.rm = TRUE) }
  
  if (max(file$Snake_max_Pheno, na.rm = TRUE) > snake_max_pheno){
    snake_max_pheno = max(file$Snake_max_Pheno, na.rm = TRUE) }
}
