...
collect_data_points <- function(files) {
  ...
  mean = mean(c(file$Newt_mean_Pheno, file$Snake_mean_Pheno))
  sd = sd(c(file$Newt_mean_Pheno, file$Snake_mean_Pheno))
  ...
  return(c(newt_max_pheno_1, snake_max_pheno_1, newt_min_pheno_1, snake_min_pheno_1, true_max_1, true_min_1, min_difference_1, max_difference_1, mean, sd))
}


phenotype_graph <- function(files, the_mean, the_sd, title){

  file1 <- read.table(files[1], header = TRUE)
p <- ggplot(file1, aes(x=gen)) +
  xlim(0, 1000)+
  #ylim(0, true_max_1)+
  scale_y_log10(limits=c(the_mean-(the_sd*10), the_mean+(the_sd*10)))+
...
differnce_graph <- function(files, the_mean, the_sd, title){
...
p <- ggplot(file1, aes(x=gen)) +
  ...
  #scale_y_log10(limits=c(min_difference_1, max_difference_1))+
  geom_line(aes(y = abs(Snake_mean_Pheno - Newt_mean_Pheno)), color = "mediumseagreen") + 
    ggtitle("Wrong1sim: Difference Between Phenotypes (Snakes-Newts)") +
  xlab("Generation") + ylab("Average Difference")+
  theme_bw()
...
p <- ggplot(file1, aes(x=1:144)) +
  xlim(0, 145)+
  #ylim(newt_min_pheno_1, newt_max_pheno_1)+
  geom_point(aes(x = 1, y = Newt_mean_Pheno[1]), color = darken("darkred")) +
  geom_point(aes(x = 1, y = Newt_mean_Pheno[50]), color = lighten("darkred")) +
  geom_point(aes(x = 1, y = Snake_mean_Pheno[1]), color = darken("steelblue")) +
  geom_point(aes(x = 1, y = Snake_mean_Pheno[50]), color = lighten("steelblue")) +
  ggtitle("Wrong1sim: Phenotype Change") +
...
for (current_file in files){
  ...
  file <- read.table(current_file, header = TRUE)
 p <- p + geom_point(data= file, x = i, aes(y = Newt_mean_Pheno[1]), color = darken("darkred")) +
   geom_point(data= file,x = i, aes(y = Newt_mean_Pheno[50]), color = lighten("darkred"))  + geom_point(data= file, x = i, aes(y = Snake_mean_Pheno[1]), color = darken("steelblue")) +
  geom_point(data= file, x = i, aes(y = Snake_mean_Pheno[50]), color = lighten("steelblue"))
 i = i+1
}
...
p <- ggplot(file1, aes(x=Newt_mean_Pheno)) +
  #ylim(0, true_max_1)+
  geom_line(aes(y = (log(Newt_mean_Pheno)*10)), color = "darkred") + 
  ggtitle("Wrong1sim: Newt trasnformed vs un-trasformed") +
  xlab("Trasnformed") + ylab("Untransformed")+
  theme_bw()
q <- ggplot(file1, aes(x=Snake_mean_Pheno)) +
  #ylim(0, true_max_1)+
  geom_line(aes(y = (log(Snake_mean_Pheno)*10)), color = "steelblue") + 
  ggtitle("Wrong1sim: Newt trasnformed vs un-trasformed") +
  xlab("Trasnformed") + ylab("Untransformed")+
  theme_bw()
...
for (current_file in files){
  ...
  file <- read.table(current_file, header = TRUE)
 p <- p + geom_line(data=file, aes(y = (log(Newt_mean_Pheno)*10)), color = "darkred") 

 q <- q + geom_line(data=file, aes(y = (log(Snake_mean_Pheno)*10)), color="steelblue", linetype="twodash")
}
...
p <- ggplot(file1, aes(x=gen)) +
  ...
  geom_line(aes(y = Newt_mean_Pheno), color = "darkred") + 
  geom_line(aes(y = Snake_mean_Pheno), color="steelblue", linetype="twodash")+
  ggtitle("1sim: Phenotype Measurements for Newts and Snakes") +
  xlab("Generation") + ylab("Average Phenotypes (Log)")+
  theme_bw()
...
p <- ggplot(file1, aes(x=gen)) +
  ...
  geom_line(aes(y = abs(Snake_mean_Pheno - Newt_mean_Pheno)), color = "mediumseagreen") + 
    ggtitle("1sim: Difference Between Phenotypes (Snakes-Newts)") +
  xlab("Generation") + ylab("Average Difference")+
  theme_bw()
...
p <- ggplot(file1, aes(x=Newt_mean_Pheno)) +
  #ylim(0, true_max_1)+
  geom_line(aes(y = (log(Newt_mean_Pheno)*10)), color = "darkred") + 
  ggtitle("1sim: Newt trasnformed vs un-trasformed") +
  xlab("Trasnformed") + ylab("Untransformed")+
  theme_bw()
q <- ggplot(file1, aes(x=Snake_mean_Pheno)) +
  #ylim(0, true_max_1)+
