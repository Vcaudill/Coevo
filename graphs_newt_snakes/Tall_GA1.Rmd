...
var_cor <- function(file, cfile, title, subt, x_label, y_label, min_gen, max_gen){
  ...
  #cfile$snake_newt_rep <- paste0("Newt_", cfile$newt_mu_rate, "_", cfile$newt_mu_effect_sd, "_Snake_", cfile$snake_mu_rate, "_", cfile$snake_mu_effect_sd, "_", cfile$rep)
...
params$snake_newt_rep <- paste0(params$snake, "_", params$newt)
return(params)
}
...
data_long_mean_short$y_loc<- rep(c(rep.int(5, 2),rep.int(4, 2),rep.int(3, 2),rep.int(2, 2),rep.int(1, 2)),20)
...
I had rows and columns flipped. After correcting for that everything looks better!
