...
```{r, graphing by gen}
trends_by_gen(GA1_tall_tall_file, title="Space: Newt VS Snake Population Size GA1", subt="Gen 16sims", y_label="Mean Phenotype", x_label="Generations", 100, 50000)
...
for(i in 1:length(GA1_pattern)){
  myine<-cor_trends_by_gen(GA1_tall_tall_file, GA1_cor_tall_file, "test", "GA1", "newt/snake GAs&rep","other", "Cor", min_gen=100, max_gen=25000, pattern=GA1_pattern[i])
  plot(myine)
}
