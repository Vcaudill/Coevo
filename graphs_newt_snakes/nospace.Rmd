...
The beta values between no space and the space simulations don't seem to change that much. I noticed that the beta values range in no space were smaller from -0.1 to 0.1ish compared to the spatial simulation -0.2 to 0.2.
