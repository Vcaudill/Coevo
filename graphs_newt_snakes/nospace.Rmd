...
see if there is a difference in the distribution of phenotypes between the space and no space simulations. Currently running 9-13-2021
...
## Graphs from Selection coef

* the spaceship, x, whales, and betas 
...
hist(unlist(beta_s[ , 2:52]), col=rgb(173,216,230,max = 255, alpha = 80, names = "lt.blue"), main="Beta Values", xlab="Beta", breaks=15) 
