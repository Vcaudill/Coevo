...
for(i in seq(1, length(inter_tall), 1)){
  ...
  cor_temp_file$sim <-
  cor_temp_file$rep <-unlist(str_split(unlist(str_split(inter_tall_cor_files[i],"rep_"))[3], "_"))[1]
  ...
  inter_grid_temp_file$rep <-unlist(str_split(unlist(str_split(inter_inter_grid_tall_files[i],"rep_"))[3], "_"))[1]
