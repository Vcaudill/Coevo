...
trends_by_gen(GA1_tall_tall_7_file, title="Space Tall: Newt VS Snake Population Size GA1", subt="Gen 16sims", y_label="Mean Phenotype", x_label="Generations", 100, 50000)
...
aggregate(GA1_tall_tall_7_file[which(GA1_tall_tall_7_file$generation>=100 & GA1_tall_tall_7_file$generation<=50000),]$dif, list(GA1_tall_tall_7_file[which(GA1_tall_tall_7_file$generation>=100 & GA1_tall_tall_7_file$generation<=50000),]$group_rep), FUN=mean) 
...
whale_gen(GA1_tall_tall_7_file, title="Space: Newt VS Snake Population Size Color=S-N Phenotype", subt="Gen 16sims", y_label="Snake-Newt Popsize", x_label="Snake-Newt Phenotype", min_gen=min_gen, max_gen=max_gen, rep=rep )

suppressMessages(print(two_hist_all_rep(GA1_tall_tall_7_file, title="Snake-Newt Winning Hist", subt="Gen 16sims", y_label="Count", x_label="Snake-Newt Popsize/100 (green) & Snake-Newt Phenotype (purple)",  min_gen=min_gen, max_gen=max_gen)))
...
boxplot_cors_by_gen(GA1_cor_tall_7_file, "Simulation Correlation 7 Comparied to Real Correlation Trials", "GA1", "newt/snake GAs&rep", "Cor", ginmin, ginmax)


four_types_boxplot_cors_by_gen(GA1_cor_tall_7_file, "Simulation four Correlation 7", "GA1", "newt/snake GAs&rep", "Cor", ginmin, ginmax)



suppressMessages(print(hist_cors_by_gen_col_rep(GA1_cor_tall_7_file, "Simulation Correlation 7 Comparied to Real Correlation", "GA1", "newt/snake GAs&rep", "Cor", ginmin, ginmax)))
...
```{r, ga1 cor 7 and pheno}
GA1_pattern_7 <- unique(paste0(GA1_tall_tall_7_file$snake_mu_rate, "_", GA1_tall_tall_7_file$snake_mu_effect_sd,"_",GA1_tall_tall_7_file$newt_mu_rate, "_", GA1_tall_tall_7_file$newt_mu_effect_sd, "_", GA1_tall_tall_7_file$rep))
for(i in 1:length(GA1_pattern_7)){
  myine<-cor_trends_by_gen(GA1_tall_tall_7_file, GA1_cor_tall_file, "test", "GA1", "newt/snake GAs&rep","other", "Cor", min_gen=100, max_gen=50000, pattern=GA1_pattern_7[i])
  plot(myine)
}
...
min_gen=100
max_gen=5000
GA1_tall_tall_7_file_temp<-GA1_tall_tall_7_file
GA1_tall_tall_7_file_temp$rep<-as.numeric(GA1_tall_tall_7_file_temp$rep)+4
test<-rbind(GA1_tall_tall_file, GA1_tall_tall_7_file_temp)

# summary
GA_summary(rbind(GA1_tall_tall_file, GA1_tall_tall_7_file_temp), min_gen=min_gen, max_gen=max_gen, x_line="Newt_pop_size", y_line="Snake_pop_size", title="Space: Newt VS Snake Population Size", subt="Gen 16sims", y_label="Snake Popsize", x_label="Newt Popsize")
...
GA_summary(rbind(GA1_tall_tall_file, GA1_tall_tall_7_file_temp), min_gen=min_gen, max_gen=max_gen, x_line="dif", y_line="Snake_pop_size", title="Space: Dif VS Snake Population Size", subt="Gen 16sims", y_label="Snake Popsize", x_label="Dif")
...
max_gen=5000
#heatmap
build_heatmap(rbind(GA1_tall_tall_file, GA1_tall_tall_7_file_temp), min_gen=min_gen, max_gen=max_gen, fill_line="Snake_pop_size", fill_line_text="Snake Population Size", title="Newt GA by Snake GA", subt="16 Sim Heatmap", y_label="Snake GA", x_label="Newt GA", red_blue=F)
...
min_gen=100
max_gen=5000
build_heatmap(rbind(GA1_tall_tall_file, GA1_tall_tall_7_file_temp), min_gen=min_gen, max_gen=max_gen, fill_line="dif", fill_line_text="Snake-Newt", title="Newt GA by Snake GA", subt="16 Sim Heatmap", y_label="Snake GA", x_label="Newt GA",red_blue=T)
...
file_name= "Snake_1e-09_0.05_Newt_1e-09_0.05_2"
spegen=25001
...
### Snake_1e-08_0.005_Newt_1e-08_0.005_3
