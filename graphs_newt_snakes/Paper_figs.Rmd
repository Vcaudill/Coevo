...
#smallset = file[which(file$gen>=40000 & file$gen<=50000 & file$exp=="Cost Gradent Map" & file$cor_score=="True"),]
file$exp = factor(file$exp, levels=c("Cost Gradent Map No Interaction", "Snake Gradent Map", "Newt Gradent Map"))
...
boxplot_dif_in_phenotype <- function(file, title, subt, x_label, y_label,gen_l, gen_h,lowest){
...
data$order = paste0("(",data$mv_dif,")", data$snake_newt)
...
boxplot_dif_in_phopulationsize <- function(file, title, subt, x_label, y_label, gen_l, gen_h, lowest){
...
boxplot_dif_in_phenotype_less_log <- function(file, title, subt, x_label, y_label,gen_l, gen_h){
...
boxplot_dif_in_phopulationsize_less_log <- function(file, title, subt, x_label, y_label, gen_l, gen_h){
...
gen_h=50000
lowest="1e-08_0.005"
title="Phenotype Difference by Mutatinal Varance"
subt="Experiment GA1_lit"
x_label = "Sanke GA - Newt GA"
y_label = "Difference in Phenotype (Snake - Newt)"
boxplot_dif_in_phenotype (GA1_lit, title, subt, x_label, y_label,gen_l, gen_h,lowest)
title="Populationsize Difference by Mutatinal Varance"
y_label = "Difference in Population Size (Snake - Newt)"
boxplot_dif_in_phopulationsize(GA1_lit, title, subt, x_label, y_label,gen_l, gen_h,lowest)


title="Phenotype Difference by Mutatinal Varance" 
subt="Experiment mu_a_lit"
x_label = "Simulations"
y_label = "Difference in Phenotype"
lowest="1e-08_0.005"
boxplot_dif_in_phenotype (mu_a_lit, title, subt, x_label, y_label,gen_l, gen_h,lowest)
title="Populationsize Difference by Mutatinal Varance"
y_label = "Difference in Population Size"
boxplot_dif_in_phopulationsize(mu_a_lit, title, subt, x_label, y_label,gen_l, gen_h,lowest)
...
y_label = "Difference in Phenotype"
lowest="1e-09_0.0158"
boxplot_dif_in_phenotype (mu_b_lit, title, subt, x_label, y_label,gen_l, gen_h,lowest)
title="Populationsize Difference by Mutatinal Varance"
y_label = "Difference in Population Size"
boxplot_dif_in_phopulationsize(mu_b_lit, title, subt, x_label, y_label,gen_l, gen_h,lowest)
...
y_label = "Difference in Phenotype"
lowest="1e-10_0.05"
boxplot_dif_in_phenotype (mu_c_lit, title, subt, x_label, y_label,gen_l, gen_h,lowest)
title="Populationsize Difference by Mutatinal Varance"
y_label = "Difference in Population Size"
boxplot_dif_in_phopulationsize(mu_c_lit, title, subt, x_label, y_label,gen_l, gen_h,lowest)
...
y_label = "Difference in Phenotype"
lowest="1e-11_0.158"
boxplot_dif_in_phenotype (mu_d_lit, title, subt, x_label, y_label,gen_l, gen_h,lowest)
title="Populationsize Difference by Mutatinal Varance"
y_label = "Difference in Population Size"
boxplot_dif_in_phopulationsize(mu_d_lit, title, subt, x_label, y_label,gen_l, gen_h,lowest)

title="Phenotype Difference by Mutatinal Varance" 
subt="Experiment v_a_lit" 
x_label = "Simulations" 
y_label = "Difference in Phenotype"
boxplot_dif_in_phenotype_less_log (v_a_lit, title, subt, x_label, y_label,gen_l, gen_h)
title="Populationsize Difference by Mutatinal Varance"
y_label = "Difference in Population Size"
boxplot_dif_in_phopulationsize_less_log(v_a_lit, title, subt, x_label, y_label,gen_l, gen_h)

title="Phenotype Difference by Mutatinal Varance"
subt="Experiment v_b_lit"
x_label = "Simulations"
y_label = "Difference in Phenotype"
boxplot_dif_in_phenotype_less_log (v_b_lit, title, subt, x_label, y_label,gen_l, gen_h)
title="Populationsize Difference by Mutatinal Varance"
y_label = "Difference in Population Size"
boxplot_dif_in_phopulationsize_less_log(v_b_lit, title, subt, x_label, y_label,gen_l, gen_h)

title="Phenotype Difference by Mutatinal Varance"
subt="Experiment v_c_lit"
x_label = "Simulations" 
y_label = "Difference in Phenotype"
boxplot_dif_in_phenotype_less_log (v_c_lit, title, subt, x_label, y_label,gen_l, gen_h)
title="Populationsize Difference by Mutatinal Varance"
y_label = "Difference in Population Size"
boxplot_dif_in_phopulationsize_less_log(v_c_lit, title, subt, x_label, y_label,gen_l, gen_h)

title="Phenotype Difference by Mutatinal Varance"
subt="Experiment v_d_lit" 
x_label = "Simulations"
y_label = "Difference in Phenotype"
boxplot_dif_in_phenotype_less_log (v_d_lit, title, subt, x_label, y_label,gen_l, gen_h)
title="Populationsize Difference by Mutatinal Varance"
y_label = "Difference in Population Size"
boxplot_dif_in_phopulationsize_less_log(v_d_lit, title, subt, x_label, y_label,gen_l, gen_h)
