...
plot1 <-   ggplot(file) +
  ...
  xlab("Snake GA")+
  ylim(0,6)+
 scale_x_discrete(labels=c("1e-08_0.005" = "GA 1", "1e-09_0.05" = "GA 2", "1e-10_0.5" = "GA 3",
                             "1e-11_5" = "GA 4"))+
     theme(plot.title = element_text(size=5)) +
  #scale_fill_discrete(fornewt, labels=c('GA 1', 'GA 2', 'GA 3', 'GA 4'))+
  scale_fill_manual(values = rev(fornewt), labels=c('GA 1', 'GA 2', 'GA 3', 'GA 4'))+
...
plot2 <-   ggplot(file) +
 ...
 scale_x_discrete(labels=c("1e-08_0.005" = "GA 1", "1e-09_0.05" = "GA 2", "1e-10_0.5" = "GA 3",
  ...
  scale_fill_manual(values = forsnake, labels=c('GA 1', 'GA 2', 'GA 3', 'GA 4'))+
  #scale_alpha(guide = 'none')+
    #labs(fill = " ")+
