...
genend_newt = aggregate(move_together_lit[which(move_together_lit$generation>=move_together_lit$Nstr_gen  & move_together_lit$Newt_mean_Pheno>=(move_together_lit$Nend)) ,]$generation, list(move_together_lit[which( move_together_lit$generation>=move_together_lit$Nstr_gen  & move_together_lit$Newt_mean_Pheno>=(move_together_lit$Nend)),]$group_rep), FUN=min)

genend_snake = aggregate(move_together_lit[which(move_together_lit$generation>=move_together_lit$Sstr_gen  & move_together_lit$Snake_mean_Pheno>=(move_together_lit$Send)) ,]$generation, list(move_together_lit[which(move_together_lit$generation>=move_together_lit$Sstr_gen  & move_together_lit$Snake_mean_Pheno>=(move_together_lit$Send)),]$group_rep), FUN=min)
...
```{r, making newts and snakes in grid form}
