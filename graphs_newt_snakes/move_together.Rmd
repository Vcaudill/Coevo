...
newt_first_mean_pheno = setNames(aggregate(move_together_lit[which(move_together_lit$generation>=100 & move_together_lit$generation<=1000),]$Newt_mean_Pheno, list(move_together_lit[which(move_together_lit$generation>=100 & move_together_lit$generation<=1000),]$group_rep), FUN=mean), c("group_rep", "Nstart" ))

snake_first_mean_pheno = setNames(aggregate(move_together_lit[which(move_together_lit$generation>=100 & move_together_lit$generation<=1000),]$Snake_mean_Pheno, list(move_together_lit[which(move_together_lit$generation>=100 & move_together_lit$generation<=1000),]$group_rep), FUN=mean) , c("group_rep", "Sstart" ))



newt_last_mean_pheno = setNames(aggregate(move_together_lit[which(move_together_lit$generation>=(max(move_together_lit$generation)-1000) & move_together_lit$generation<=max(move_together_lit$generation)),]$Newt_mean_Pheno, list(move_together_lit[which(move_together_lit$generation>=(max(move_together_lit$generation)-1000) & move_together_lit$generation<=max(move_together_lit$generation)),]$group_rep), FUN=mean), c("group_rep", "Nend" )) 

snake_last_mean_pheno = setNames(aggregate(move_together_lit[which(move_together_lit$generation>=(max(move_together_lit$generation)-1000) & move_together_lit$generation<=max(move_together_lit$generation)),]$Snake_mean_Pheno, list(move_together_lit[which(move_together_lit$generation>=(max(move_together_lit$generation)-1000) & move_together_lit$generation<=max(move_together_lit$generation)),]$group_rep), FUN=mean), c("group_rep", "Send" )) 
...
move_together_lit$Nstart = mean_phenotype_of_group[match(move_together_lit$group_rep, mean_phenotype_of_group$group_rep),"Nstart"]

move_together_lit$Sstart = mean_phenotype_of_group[match(move_together_lit$group_rep, mean_phenotype_of_group$group_rep),"Sstart"]

move_together_lit$Nend = mean_phenotype_of_group[match(move_together_lit$group_rep, mean_phenotype_of_group$group_rep),"Nend"]

move_together_lit$Send = mean_phenotype_of_group[match(move_together_lit$group_rep, mean_phenotype_of_group$group_rep),"Send"]


genstart_newt = setNames(aggregate(move_together_lit[which(move_together_lit$Newt_mean_Pheno<=(move_together_lit$Nstart)) ,]$generation, list(move_together_lit[which(move_together_lit$Newt_mean_Pheno<=(move_together_lit$Nstart)),]$group_rep), FUN=max), c("group_rep", "Nstr_gen"))


genstart_snake = setNames(aggregate(move_together_lit[which(move_together_lit$Snake_mean_Pheno<=(move_together_lit$Sstart)) ,]$generation, list(move_together_lit[which(move_together_lit$Snake_mean_Pheno<=(move_together_lit$Sstart)),]$group_rep), FUN=max), c("group_rep", "Sstr_gen"))

move_together_lit$Nstr_gen <- genstart_newt[match(move_together_lit$group_rep, genstart_newt$group_rep),'Nstr_gen']
move_together_lit$Sstr_gen <- genstart_snake[match(move_together_lit$group_rep, genstart_snake$group_rep),'Sstr_gen']


genend_newt = aggregate(move_together_lit[which(move_together_lit$generation>=move_together_lit$Nstr_gen  & move_together_lit$Newt_mean_Pheno>=(.98*(move_together_lit$Nend))) ,]$generation, list(move_together_lit[which( move_together_lit$generation>=move_together_lit$Nstr_gen  & move_together_lit$Newt_mean_Pheno>=(.98*move_together_lit$Nend)),]$group_rep), FUN=min)

genend_snake = aggregate(move_together_lit[which(move_together_lit$generation>=move_together_lit$Sstr_gen  & move_together_lit$Snake_mean_Pheno>=(.98*move_together_lit$Send)) ,]$generation, list(move_together_lit[which(move_together_lit$generation>=move_together_lit$Sstr_gen  & move_together_lit$Snake_mean_Pheno>=(.98*move_together_lit$Send)),]$group_rep), FUN=min)

move_together_lit$genend_newt <- genend_newt[match(move_together_lit$group_rep, genend_newt$Group.1),'x']
move_together_lit$genend_snake <- genend_snake[match(move_together_lit$group_rep, genend_snake$Group.1),'x']

# get the difference in generation time and the difference in phenotype

npt<-ggplot(move_together_lit) +
geom_boxplot(aes(sim, genend_newt), color="darkred")
spt<-ggplot(move_together_lit) +
geom_boxplot(aes(sim, genend_snake), color="steelblue")
#  geom_point(aes(group_rep, genend_newt), color="darkred")+
 # geom_point(aes(group_rep, genend_snake), color="steelblue")
grid.arrange(npt, spt, ncol=1)
ggplot(move_together_lit) +
  facet_wrap(~sim)+
geom_point(aes(rep, genend_newt), color="darkred")+
geom_point(aes(rep, genend_snake), color="steelblue")

ggplot(move_together_lit) +
geom_boxplot(aes(sim, genend_snake-genend_newt), color="black")
