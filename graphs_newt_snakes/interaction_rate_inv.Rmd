...
Think, explore, & write about what the co-evolutionary interaction between newts & snakes with different genetic architectures (GAs, combination of mutation rate & mutation effect size) can lead to. This markdown is investigating
...
build_heatmap <- function(file, min_gen, max_gen, fill_line, fill_line_text, title, subt, y_label, x_label, red_blue=F){
 ...
 my_plot <- ggplot(params, aes(newt,  paste0(interrate, "_", snake, "_", rep))) +    # Create heatmap with ggplot2
  ggtitle(title, subtitle = paste0(subt, " From ", min_gen, " gen to ", max_gen, " gen")) +
  xlab(x_label) + ylab(y_label)+
...
whale_gen(GA1_lit_interrate_file, title="Space: Newt VS Snake Population Size Color=S-N Phenotype", subt="Gen 16sims", y_label="Snake Popsize", x_label="Newt Phenotype", min_gen=min_gen, max_gen=max_gen, rep=rep )
```
...
cor_trends_by_gen(GA1_lit_interrate_file, GA1_cor_interrate_file, "test", "GA1", "newt/snake GAs&rep","other", "Cor", min_gen=100, max_gen=50000, pattern=GA1_pattern[myrandomlist[1]])
...
cor_trends_by_gen(GA1_lit_interrate_file, GA1_cor_interrate_file, "test", "GA1", "newt/snake GAs&rep","other", "Cor", min_gen=100, max_gen=50000, pattern=GA1_pattern[myrandomlist[2]])
```

### Random 3 (5 sec)
```{r, random cor-pheno plot 3}

cor_trends_by_gen(GA1_lit_interrate_file, GA1_cor_interrate_file, "test", "GA1", "newt/snake GAs&rep","other", "Cor", min_gen=100, max_gen=50000, pattern=GA1_pattern[myrandomlist[3]])
```
...
### Random 1 
```{r, GA1 pop size 1}
pop_size_trends_by_gen(GA1_lit_interrate_file, GA1_cor_interrate_file, "test", "GA1", "newt/snake GAs&rep","other", "Cor", min_gen=100, max_gen=50000, pattern=GA1_pattern[myrandomlist[1]])
...
pop_size_trends_by_gen(GA1_lit_interrate_file, GA1_cor_interrate_file, "test", "GA1", "newt/snake GAs&rep","other", "Cor", min_gen=100, max_gen=50000, pattern=GA1_pattern[myrandomlist[2]])
```

### Random 3 
```{r, random pop size plot 3}

pop_size_trends_by_gen(GA1_lit_interrate_file, GA1_cor_interrate_file, "test", "GA1", "newt/snake GAs&rep","other", "Cor", min_gen=100, max_gen=50000, pattern=GA1_pattern[myrandomlist[3]])
```
...
```{r, interrate earlyplots Heatmap1, fig.height=4}
min_gen=100
max_gen=5000
...
### interrate: Population Size (EM1)  
```{r, interrate earlyplots Heatmap2, fig.height=4}
min_gen=5000
max_gen=10000
...
### interrate: Population Size (EM2)  
```{r, interrate earlyplots Heatmap3, fig.height=4}
min_gen=10000
max_gen=15000
...
### interrate: Population Size (EM3)  
```{r, interrate earlyplots Heatmap4, fig.height=4}
min_gen=15000
max_gen=20000
...
### interrate: Population Size (EM4)  
```{r, interrate earlyplots Heatmap5, fig.height=4}
min_gen=20000
max_gen=25000
...
### interrate: Population Size (ML1)  
```{r, interrate midplots Heatmap7, fig.height=4}
min_gen=30000
max_gen=35000
...
### interrate: Population Size (ML2)  
```{r, interrate midplots Heatmap8, fig.height=4}
min_gen=35000
max_gen=40000
...
### interrate: Population Size (ML3)  
```{r, interrate midplots Heatmap9, fig.height=4}
min_gen=40000
max_gen=45000
...
### interrate: Phenotype (EM1) 
```{r, interrate earlyplots Heatmap2 pheno, fig.height=4}
...
### interrate: Phenotype (EM2) 
```{r, interrate earlyplots Heatmap3 pheno, fig.height=4}
...
### interrate: Phenotype (EM3) 
```{r, interrate earlyplots Heatmap4 pheno, fig.height=4}
...
### interrate: Phenotype (EM4) 
```{r, interrate earlyplots Heatmap5 pheno, fig.height=4}
...
### interrate: Phenotype (ML1) 
```{r, interrate earlyplots Heatmap7 pheno, fig.height=4}
...
### interrate: Phenotype (ML2) 
```{r, interrate earlyplots Heatmap8 pheno, fig.height=4}
...
### interrate: Phenotype (ML3) 
```{r, interrate earlyplots Heatmap9 pheno, fig.height=4}
