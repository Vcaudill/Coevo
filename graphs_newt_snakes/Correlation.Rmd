...
lit_5000_files <- list.files(path="~/Desktop/cor_5000/text_files", pattern="GA6_lit_", full.names=TRUE, recursive=FALSE)
cor_5000_files <- list.files(path="~/Desktop/cor_5000/text_files", pattern="GA6_cor_", full.names=TRUE, recursive=FALSE)

lit_20000_files <- list.files(path="~/Desktop/cor_20000/text_files", pattern="GA6_lit_", full.names=TRUE, recursive=FALSE)
cor_20000_files <- list.files(path="~/Desktop/cor_20000/text_files", pattern="GA6_cor_", full.names=TRUE, recursive=FALSE)

lit_100000_files <- list.files(path="~/Desktop/cor_20000/text_files", pattern="GA6_lit_", full.names=TRUE, recursive=FALSE)
cor_100000_files <- list.files(path="~/Desktop/cor_20000/text_files", pattern="GA6_cor_", full.names=TRUE, recursive=FALSE)

lit_5000_files_88 <- list.files(path="~/Desktop/cor_5000/text_files", pattern="GA88_lit_", full.names=TRUE, recursive=FALSE)
cor_5000_files_88 <- list.files(path="~/Desktop/cor_5000/text_files", pattern="GA88_cor_", full.names=TRUE, recursive=FALSE)

lit_5000_files_1010 <- list.files(path="~/Desktop/cor_5000/text_files", pattern="GA1010_lit_", full.names=TRUE, recursive=FALSE)
cor_5000_files_1010 <- list.files(path="~/Desktop/cor_5000/text_files", pattern="GA1010_cor_", full.names=TRUE, recursive=FALSE)

lit_5000_files_2020 <- list.files(path="~/Desktop/cor_5000/text_files", pattern="GA2020_lit_", full.names=TRUE, recursive=FALSE)
cor_5000_files_2020 <- list.files(path="~/Desktop/cor_5000/text_files", pattern="GA2020_cor_", full.names=TRUE, recursive=FALSE)

GA2_lit_5000_files <- list.files(path="~/Desktop/cor_GA2_5000/text_files", pattern="GA55_lit_", full.names=TRUE, recursive=FALSE)
GA2_cor_5000_files <- list.files(path="~/Desktop/cor_GA2_5000/text_files", pattern="GA55_cor_", full.names=TRUE, recursive=FALSE)
