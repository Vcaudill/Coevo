---
title: "No Interaction on a Cost Grade"
...
foldername=no_interaction_cost_grade
...
no_interaction_cost_grade_lit<- read.csv("~/Desktop/no_interaction_cost_grade/all_lit.txt" , header = TRUE)

no_interaction_cost_grade_lit$group_rep <- paste0(no_interaction_cost_grade_lit$snake_mu_rate, "_", no_interaction_cost_grade_lit$snake_mu_effect_sd,"_",no_interaction_cost_grade_lit$newt_mu_rate, "_", no_interaction_cost_grade_lit$newt_mu_effect_sd, "_", no_interaction_cost_grade_lit$rep)

no_interaction_cost_grade_lit$group <- paste0(no_interaction_cost_grade_lit$snake_mu_rate, "_", no_interaction_cost_grade_lit$snake_mu_effect_sd,"_",no_interaction_cost_grade_lit$newt_mu_rate, "_", no_interaction_cost_grade_lit$newt_mu_effect_sd)

no_interaction_cost_grade_lit$sim=LETTERS[factor(no_interaction_cost_grade_lit$group)]
no_interaction_cost_grade_lit$dif <- no_interaction_cost_grade_lit$Snake_mean_Pheno-no_interaction_cost_grade_lit$Newt_mean_Pheno


no_interaction_cost_grade_cor<- read.csv("~/Desktop/no_interaction_cost_grade/all_cor.txt" , header = TRUE)
no_interaction_cost_grade_cor$group_rep <- paste0(no_interaction_cost_grade_cor$snake_mu_rate, "_", no_interaction_cost_grade_cor$snake_mu_effect_sd,"_",no_interaction_cost_grade_cor$newt_mu_rate, "_", no_interaction_cost_grade_cor$newt_mu_effect_sd, "_", no_interaction_cost_grade_cor$rep)
no_interaction_cost_grade_cor$group <- paste0(no_interaction_cost_grade_cor$snake_mu_rate, "_", no_interaction_cost_grade_cor$snake_mu_effect_sd,"_",no_interaction_cost_grade_cor$newt_mu_rate, "_", no_interaction_cost_grade_cor$newt_mu_effect_sd)
no_interaction_cost_grade_cor$sim=LETTERS[factor(no_interaction_cost_grade_cor$group)]
...
#file=no_interaction_cost_grade_lit
#cfile=no_interaction_cost_grade_cor 
...
#two_hist_death_all_rep(no_interaction_cost_grade_lit, title="Snake-Newt Winning Hist", subt="Gen 16sims", y_label="Count", x_label="Snake-Newt Phenotype (purple) & Snake-Newt Popsize/100 (green)",  min_gen=20000, max_gen=25000)
...
```{r, graphing by gen}
trends_by_gen(no_interaction_cost_grade_lit, title="Space Tall: Newt VS Snake Population Size GA1", subt="Gen 16sims", y_label="Mean Phenotype", x_label="Generations", 1000, 50000, rep=1)


#aggregate(no_interaction_cost_grade_lit[which(no_interaction_cost_grade_lit$generation>=100 & no_interaction_cost_grade_lit$generation<=50000),]$dif, list(no_interaction_cost_grade_lit[which(no_interaction_cost_grade_lit$generation>=100 & no_interaction_cost_grade_lit$generation<=50000),]$group_rep), FUN=mean) 
...
aggregate(no_interaction_cost_grade_lit[which(no_interaction_cost_grade_lit$generation>=100 & no_interaction_cost_grade_lit$generation<=50000),]$dif, list(no_interaction_cost_grade_lit[which(no_interaction_cost_grade_lit$generation>=100 & no_interaction_cost_grade_lit$generation<=50000),]$group), FUN=mean) 
```
...
whale_gen(no_interaction_cost_grade_lit, title="Space: Newt VS Snake Population Size Color=S-N Phenotype", subt="Gen 16sims", y_label="Snake Popsize", x_label="Newt Phenotype", min_gen=min_gen, max_gen=max_gen, rep=rep )
```

### Phenotype & Populationsize differences
```{r, popsize and pheno}

suppressMessages(print(two_hist(no_interaction_cost_grade_lit, title="Snake-Newt Winning Hist", subt="Gen 16sims", y_label="Count", x_label="Snake-Newt Popsize/1000 (green) & Snake-Newt Phenotype (purple)",  min_gen=min_gen, max_gen=max_gen, rep=rep )))

#suppressMessages(print(two_hist_all_rep(no_interaction_cost_grade_lit, title="Snake-Newt Winning Hist", subt="Gen 16sims", y_label="Count", x_label="Snake-Newt Popsize/100 (green) & Snake-Newt Phenotype (purple)",  min_gen=min_gen, max_gen=max_gen)))
...
boxplot_cors_by_gen(no_interaction_cost_grade_cor, "Simulation Correlation Comparied to Real Correlation Trials", "GA1", "newt/snake GAs&rep", "Cor", ginmin, ginmax)


#four_types_boxplot_cors_by_gen(no_interaction_cost_grade_cor, "Simulation four Correlation", "GA1", "newt/snake GAs&rep", "Cor", ginmin, ginmax)
...
ginmin = 0
ginmax = 5000
suppressMessages(print(hist_cors_by_gen_col_rep(no_interaction_cost_grade_cor, "Simulation Correlation Comparied to Real Correlation", "GA1", "newt/snake GAs&rep", "Cor", ginmin, ginmax)))
```
...
### Random 1  
```{r, GA1 cor and pheno}
GA1_pattern <- unique(paste0(no_interaction_cost_grade_lit$snake_mu_rate, "_", no_interaction_cost_grade_lit$snake_mu_effect_sd,"_",no_interaction_cost_grade_lit$newt_mu_rate, "_", no_interaction_cost_grade_lit$newt_mu_effect_sd, "_", no_interaction_cost_grade_lit$rep))

myrandomlist=sample.int(length(GA1_pattern), 3)

# for(i in myrandomlist){
#   myine<-cor_trends_by_gen(no_interaction_cost_grade_lit, no_interaction_cost_grade_cor, "test", "GA1", "newt/snake GAs&rep","other", "Cor", min_gen=100, max_gen=50000, pattern=GA1_pattern[i])
#   plot(myine)
# }

cor_trends_by_gen(no_interaction_cost_grade_lit, no_interaction_cost_grade_cor, "test", "GA1", "newt/snake GAs&rep","other", "Cor", min_gen=100, max_gen=50000, pattern=GA1_pattern[myrandomlist[1]])
...
cor_trends_by_gen(no_interaction_cost_grade_lit, no_interaction_cost_grade_cor, "test", "GA1", "newt/snake GAs&rep","other", "Cor", min_gen=100, max_gen=50000, pattern=GA1_pattern[myrandomlist[2]])
```

### Random 3  
```{r, random cor-pheno plot 3}

cor_trends_by_gen(no_interaction_cost_grade_lit, no_interaction_cost_grade_cor, "test", "GA1", "newt/snake GAs&rep","other", "Cor", min_gen=100, max_gen=50000, pattern=GA1_pattern[myrandomlist[3]])
```
...
# for(i in 1:length(unique(no_interaction_cost_grade_lit$rep))){
#   myine<-whale_gen(no_interaction_cost_grade_lit, title="Space: Newt VS Snake Population Size Color=S-N Phenotype", subt="Gen 16sims", y_label="Snake Popsize", x_label="Newt Popsize", min_gen=min_gen, max_gen=max_gen, rep=unique(no_interaction_cost_grade_lit$rep)[i])
#   plot(myine)
# 
# }
whale_gen(no_interaction_cost_grade_lit, title="Space: Newt VS Snake Population Size Color=S-N Phenotype", subt="Gen 16sims", y_label="Snake Popsize", x_label="Newt Popsize", min_gen=min_gen, max_gen=max_gen, rep=unique(no_interaction_cost_grade_lit$rep)[1])
```
...
# for(i in 1:length(unique(no_interaction_cost_grade_lit$rep))){
#   myine<-two_hist(no_interaction_cost_grade_lit, title="Snake-Newt Winning Hist", subt="Gen 16sims", y_label="Count", x_label="Snake-Newt Phenotype (purple) & Snake-Newt Popsize/100 (green)",  min_gen=min_gen, max_gen=max_gen, rep=unique(no_interaction_cost_grade_lit$rep)[i] )
#   suppressMessages(plot(myine))
# }

two_hist(no_interaction_cost_grade_lit, title="Snake-Newt Winning Hist", subt="Gen 16sims", y_label="Count", x_label="Snake-Newt Phenotype (purple) & Snake-Newt Popsize/100 (green)",  min_gen=min_gen, max_gen=max_gen, rep=unique(no_interaction_cost_grade_lit$rep)[1] )
...
min_gen=100
max_gen=5000
GA_summary(no_interaction_cost_grade_lit, min_gen=min_gen, max_gen=max_gen, x_line="Newt_pop_size", y_line="Snake_pop_size", title="Space: Newt VS Snake Population Size", subt="Gen 16sims", y_label="Snake Popsize", x_label="Newt Popsize")
```
...
GA_summary(no_interaction_cost_grade_lit, min_gen=min_gen, max_gen=max_gen, x_line="dif", y_line="Snake_pop_size", title="Space: Dif VS Snake Population Size", subt="Gen 16sims", y_label="Snake Popsize", x_label="Dif")
```
...
GA_summary_by_species(no_interaction_cost_grade_lit, min_gen=min_gen, max_gen=max_gen, x_line="dif", y_line="snake", title="Space: Dif VS Snake GA", subt="Gen 16sims", y_label="Snake GA", x_label="Dif")
...
GA_summary_by_species(no_interaction_cost_grade_lit, min_gen=min_gen, max_gen=max_gen, x_line="dif", y_line="newt", title="Space: Dif VS Newt GA", subt="Gen 16sims", y_label="Newt GA", x_label="Dif")
...
max_gen=5000
#heatmap
build_heatmap(no_interaction_cost_grade_lit, min_gen=min_gen, max_gen=max_gen, fill_line="Snake_pop_size", fill_line_text="Snake Population Size", title="Newt GA by Snake GA", subt="16 Sim Heatmap", y_label="Snake GA", x_label="Newt GA", red_blue=F)
```
...
min_gen=100
max_gen=5000
build_heatmap(no_interaction_cost_grade_lit, min_gen=min_gen, max_gen=max_gen, fill_line="dif", fill_line_text="Snake-Newt", title="Newt GA by Snake GA", subt="16 Sim Heatmap", y_label="Snake GA", x_label="Newt GA",red_blue=T)
```
...
```{r, red in grid files}
require(readr)
no_interaction_cost_grade_grid<- read.csv("~/Desktop/no_interaction_cost_grade/all_grid.txt" , header = TRUE) %>%  filter(between(generation, 9000, 10000))
no_interaction_cost_grade_grid$group_rep <- paste0(no_interaction_cost_grade_grid$snake_mu_rate, "_", no_interaction_cost_grade_grid$snake_mu_effect_sd,"_",no_interaction_cost_grade_grid$newt_mu_rate, "_", no_interaction_cost_grade_grid$newt_mu_effect_sd, "_", no_interaction_cost_grade_grid$rep)
no_interaction_cost_grade_grid$group <- paste0(no_interaction_cost_grade_grid$snake_mu_rate, "_", no_interaction_cost_grade_grid$snake_mu_effect_sd,"_",no_interaction_cost_grade_grid$newt_mu_rate, "_", no_interaction_cost_grade_grid$newt_mu_effect_sd)
no_interaction_cost_grade_grid$sim=LETTERS[factor(no_interaction_cost_grade_grid$group)]
no_interaction_cost_grade_grid$grid_num = 5
...
file=no_interaction_cost_grade_grid
...
require(readr)
no_interaction_cost_grade_grid<- read.csv("~/Desktop/no_interaction_cost_grade/all_grid.txt" , header = TRUE) %>%  filter(between(generation, 40000, 50000))
no_interaction_cost_grade_grid$group_rep <- paste0(no_interaction_cost_grade_grid$snake_mu_rate, "_", no_interaction_cost_grade_grid$snake_mu_effect_sd,"_",no_interaction_cost_grade_grid$newt_mu_rate, "_", no_interaction_cost_grade_grid$newt_mu_effect_sd, "_", no_interaction_cost_grade_grid$rep)
no_interaction_cost_grade_grid$group <- paste0(no_interaction_cost_grade_grid$snake_mu_rate, "_", no_interaction_cost_grade_grid$snake_mu_effect_sd,"_",no_interaction_cost_grade_grid$newt_mu_rate, "_", no_interaction_cost_grade_grid$newt_mu_effect_sd)
no_interaction_cost_grade_grid$sim=LETTERS[factor(no_interaction_cost_grade_grid$group)]
no_interaction_cost_grade_grid$grid_num = 5
