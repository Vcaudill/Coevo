...
for(i in seq(1, length(GA3_tall), 1)){
  stand <- unlist(str_split(unlist(str_split(GA3_tall[i],"newt_mu_rate_"))[2], "_"))[1]
  up <- unlist(str_split(unlist(str_split(GA3_tall[i],"newt_mu_effect_sd_"))[2], "_"))[1]
  ...
  GA3_temp_file$sim <-LETTERS[letter]
  #GA3_temp_file$size <-newt_numb
  ...
  GA3_grid_temp_file$sim <-LETTERS[letter]
  #GA3_grid_temp_file$size <-newt_numb
...
GA3<-GA3_grid_tall_file[which(GA3_grid_tall_file$snake_newt_rep==file_name & GA3_grid_tall_file$generation==spegen),]
