...
p = differnce_graph(files, mean_mean_dif_u5, sd_mean_dif_u5, min_difference_1_u5, max_difference_1_u5, title, is_log=FALSE)
...
Wow, theses simulations are very different from each other
...
p = differnce_graph(files, mean_mean_dif_u2, sd_mean_dif_u2, min_difference_1_u2, max_difference_1_u2, title, is_log=FALSE)
